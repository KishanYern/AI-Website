...
const homeModels = () => {
    return (
        <div
            className='bg-gradient-to-b from-blue-100 to-red-200 flex justify-center 
        items-center flex-col gap-10 pb-56'
        >
            <div className=' text-5xl pb-10'>Models</div>
                ...
                {CardData.map((card) => {
                    return (
                        <Link to={card.link} key={card.key}>
                            <div
                                key={card.key}
                                className='text-xl text-black rounded-xl p-2 h-auto md:h-5/6 w-auto cursor-pointer
