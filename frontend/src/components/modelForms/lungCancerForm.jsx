    ...
    const handleSubmit = (e) => {
        ...
        // Reorder the keys to match the DataFrame's expected order:
        const formData = {
        AGE: age,
        SMOKING: smoking,
        ...
        "FATIGUE ": fatigue,           // note the trailing space
        "ALLERGY ": allergy,           // note the trailing space
        WHEEZING: wheezing,
        "ALCOHOL CONSUMING": alcoholConsumption,
        COUGHING: excessiveCoughing,
