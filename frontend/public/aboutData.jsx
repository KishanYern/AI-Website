const aboutSection = [
    {
        data: 'In early 2024, Zahra and I (Kishan) embarked on a collaborative project to develop a variety of machine learning models. This project allowed us to explore different machine \
    ...
    {
        data: "To make these models accessible to a broader audience, I created this website as an interactive platform where users can test and experiment with the models in a user-friendly \
    ...
    {
        data: "Additionally, I have made detailed documentation available in the project's README file on my GitHub repository. This documentation covers not only the implementation of the \
