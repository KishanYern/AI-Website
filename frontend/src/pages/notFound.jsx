...
const notFound = () => {
  return (
    <div className="flex flex-col item-center justify-center bg-black h-lvh">
      <div className=' animate-bounce flex items-center justify-center'>
          ...
          </svg> {/* picture from https://tailwindcomponents.com/component/simple-404-page */}
      </div>
      <div className='flex items-center justify-center font-satoshi text-4xl pt-10 text-white'>
